  ...
  return (
    <div id="projects" className={style.procon}>
      ...
      <div className={style.myproject}>
        ...
        <div>
          <img
            src="https://github.com/Priyankadubey190/Priyankadubey190.github.io/raw/master/myportfolio/public/housedates.png"
            alt=""
            width={"100%"}
          />
          <center className={style.cen}>Nature's Basket-Clone</center>
          ...
          <div>
            <a href="https://housedates-35464.web.app/">Live Site</a>
          </div>
        </div>
        <div>
          <img
            src="https://github.com/Priyankadubey190/Priyankadubey190.github.io/raw/master/myportfolio/public/webisabi.png"
            alt=""
            width={"100%"}
          />
          <center className={style.cen}>Nature's Basket-Clone</center>
